...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        if Product.AMETHYSTS in self.params and Product.AMETHYSTS in state.order_depths:
            ...
            amethyst_take_orders, buy_order_volume, sell_order_volume = self.take_orders(Product.AMETHYSTS, state.order_depths[Product.AMETHYSTS], self.params[Product.AMETHYSTS]["fair_value"], self.params[Product.AMETHYSTS]["take_width"], amethyst_position)
            amethyst_clear_orders, buy_order_volume, sell_order_volume = self.clear_orders(Product.AMETHYSTS, state.order_depths[Product.AMETHYSTS], self.params[Product.AMETHYSTS]["fair_value"], self.params[Product.AMETHYSTS]["clear_width"], amethyst_position, buy_order_volume, sell_order_volume)
            amethyst_make_orders, _, _ = self.make_amethyst_orders(state.order_depths[Product.AMETHYSTS], self.params[Product.AMETHYSTS]["fair_value"], amethyst_position, buy_order_volume, sell_order_volume, self.params[Product.AMETHYSTS]["volume_limit"])
        ...
        if Product.STARFRUIT in self.params and Product.STARFRUIT in state.order_depths:
            ...
            starfruit_fair_value = self.starfruit_fair_value(state.order_depths[Product.STARFRUIT], self.params[Product.STARFRUIT]["timespan"])
            starfruit_take_orders, buy_order_volume, sell_order_volume = self.take_orders(Product.STARFRUIT, state.order_depths[Product.STARFRUIT], starfruit_fair_value, self.params[Product.STARFRUIT]["take_width"], starfruit_position, self.params[Product.STARFRUIT]["prevent_adverse"], self.params[Product.STARFRUIT]["adverse_volume"])
            starfruit_clear_orders, buy_order_volume, sell_order_volume = self.clear_orders(Product.STARFRUIT, state.order_depths[Product.STARFRUIT], starfruit_fair_value, self.params[Product.STARFRUIT]["clear_width"], starfruit_position, buy_order_volume, sell_order_volume)
